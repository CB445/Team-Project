...
SECRET_KEY = "django-insecure-9j5#os4e78=d3+4j0h8%s_x*#%8$4@kye!kfyjyb(!77ko=m0p"
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Live Location Logs", "url": "tracker:location_logs_dashboard"},
...
JAZZMIN_UI_TWEAKS = {
    "theme": "litera",              # light theme
    "dark_mode_theme": None,        # disable dark mode completely

    "navbar": "navbar-light navbar-white",   # FIXED
    ...
    "sidebar": "sidebar-light-primary",  # FIXED (was dark)
